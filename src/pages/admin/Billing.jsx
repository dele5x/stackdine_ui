            ...
            >
              ...
              {orders.map((o) => (
                <option key={o._id} value={o._id}>
                  {o.customer?.name} — ₦{o.totalAmount?.toLocaleString()}
                </option>
              ))}
            </select>
          </div>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Total Revenue: <span className="text-orange-400 font-semibold">₦{totalRevenue.toLocaleString()}</span>
            </p>
          </div>
          <motion.button
            whileHover={{ scale: 1.02 }}
                ...
                <tbody className="divide-y divide-gray-800">
                  {filtered.length === 0 ? (
                    ...
                    filtered.map((bill) => (
                      ...
                      >
                        <td className="px-6 py-4 text-white text-sm">{bill.customer?.name}</td>
